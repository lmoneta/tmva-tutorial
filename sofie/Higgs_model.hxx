//Code generated automatically by TMVA for Inference of Model file [Higgs_model.onnx] at [Mon Apr  4 09:48:35 2022] 
#include<algorithm>
#include<cmath>
#include<vector>
...
namespace TMVA_SOFIE_Higgs_model{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "Higgs_model.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
